...
export default function Hero() {
    return (
        <section className="relative">
            <div className="flex min-h-screen flex-col items-center justify-between p-24 bg bg-gradient-to-b from-white to-gray-200 dark:to-neutral-950 dark:from-slate-900">
                {/* Hero content */}
